...
def evaluate(beam_size):
    ...
    # For each image
    with torch.no_grad():
        for i, (v, ques, ans, item, q_length, difficulty_level, image_id) in enumerate(
            ...
            while True:
                ...
                h1 = decoder.top_down_attention(embeddings, h1)  # (batch_size_t, decoder_dim)
